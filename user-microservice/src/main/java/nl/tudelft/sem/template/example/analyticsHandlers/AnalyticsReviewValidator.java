...
public class AnalyticsReviewValidator extends BaseAnalyticsValidator {
     ...
     * @throws InvalidAnalyticsException can be thrown if the number of reviews cannot be lesser than 0
     */
    @Override
    public boolean handle(Analytics analytics) throws InvalidAnalyticsException {
        if (analytics.getReviewsNumber() < 0) {
            throw new InvalidDataException("The number of reviews cannot be lesser than 0.");
        }
